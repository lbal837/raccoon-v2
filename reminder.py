...
class OpenMessage:
    ...
    def distracted(self):
        ...
        self.activity = Label(self.distracted_frame, text="What would you like to do now?")  # see if you can label without name
        self.activity_entry = Entry(self.distracted_frame)
        self.activity_button = Button(self.distracted_frame, text="Enter", fg="red",
        ...
        self.activity.grid(row=1, columnspan=2)
        self.activity_entry.grid(row=2, column=0)
        self.activity_button.grid(row=2, column=1)
        self.break_button.grid(row=4, column=0)
    ...
    def activity_checker(self):
        if self.activity_entry.get() == '' and self.activity_error is None:
            self.activity_error = Label(self.distracted_frame, text="no activity entered! try again")
            ...
            self.hide_distracted_frame(self.stay(t))
